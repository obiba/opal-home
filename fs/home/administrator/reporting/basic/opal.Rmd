...
Any file can be extracted from Opal file system. Example of a file that is downloaded and read as a CSV file:

```{r}
lines <- opal.file(o,'/home/administrator/nasa/mars.csv')
